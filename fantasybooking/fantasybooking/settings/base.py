...
ROOT_URLCONF = 'fantasybooking.fantasybooking.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fantasybooking.fantasybooking.wsgi.application'
...
def prefixed_cookie(name):
    return 'fantasybooking_{}'.format(name)
...
DEFAULT_FROM_EMAIL = 'hello@fantasybooking.com'
SERVER_EMAIL = 'error@fantasybooking.com'
...
CONTEXT_PROCESSORS = [
    ...
    'fantasybooking.home.context_processors.settings',
